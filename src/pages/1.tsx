...
export default function One() {
    ...
    const [numArray, setNumArray] = useState<string>('Enter multiple values and add , to split them')
        ...
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-full h-full flex flex-col justify-center items-center gap-[50px]">
                ...
                <div className="w-9/10 flex flex-row justify-center">
                    <input onChange={onChange} type="text" placeholder="Type here" className="input w-3/5" />
                    <DefaultSelect className="w-2/5 max-w-[100px]" defaultSelection={availableMethods[0]} selection={availableMethods} setSelection={setMethod} />
                </div>
            </div>
        </div>
    )
